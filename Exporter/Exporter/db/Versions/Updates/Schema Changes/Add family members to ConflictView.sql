...
--SELECT DISTINCT FamilyMember FROM ConflictView -- 631


--SELECT * FROM Conflict WHERE (Eric = 1) OR (Melania = 1) OR (Junior = 1)
...
--SELECT * FROM ConflictView	ORDER BY FamilyMember